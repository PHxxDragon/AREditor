...
namespace EAR.Integration
{
    public class ReactPlugin : MonoBehaviour
    {
        ...
        SceneLoaded();
            ...
            assetObject1.url = "https://ear-storage.s3.ap-southeast-1.amazonaws.com/models/1/1650257537777_enc_model_50a_-_hatchling_hawksbill_sea_turtle.zip";
            ...
            assetObject2.url = "https://ear-storage.s3.ap-southeast-1.amazonaws.com/models/1/1650257404059_enc_tiger_howl_v04.zip";
...
/*            AssetObject assetObject4 = new AssetObject();
            ...
            assetInformation.metadata = LocalStorage.Load("abcde");
