...
namespace RuntimeHandle
{
    ...
    public class ScaleAxis : HandleBase
    {
        ...
        public override void Interact(Vector3 p_previousPosition)
        {
            ...
            Vector3 normalizedAxisVectorOfObjectOnScreen = axisVectorOfObjectOnScreen.normalized;

            mouseVector *= Time.deltaTime * RuntimeTransformHandle.MOUSE_SENSITIVITY;

            float d = Vector3.Dot(normalizedAxisVectorOfObjectOnScreen, mouseVector);
